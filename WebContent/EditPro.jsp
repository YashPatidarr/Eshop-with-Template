...
<div class="row">
	...
	<hr class="soft"/>
	<div class="well">
	<form action="UProUpd.jsp" >
		<h3>Your Personal Details</h3>
		<div class="control-group">
			<label class="control-label" for="inputFname">Name <sup>*</sup></label>
			<div class="controls">
			<h1>Edit details of <%=name %></h1>
			  <input type="hidden"  id="inputFname" placeholder="name" name="nm">
			</div>
		 </div>
		 <div class="control-group">
		...
		<div class="control-group">
          ...
          <div class="controls">
          Male<input type="radio" name="gen" value ="Male">Female<input type="radio"
...
<option>Ratlam</option>
		...
		<div class="control-group">
          ...
          <div class="controls">
            <input name="text" type="text" placeholder="Cont no." name="num" value ="<%=num %>">
          </div>
		  </div>
		<div class="control-group">
		<div class="controls">
		 <input type="submit" name="EditAccount" value="Update Profile" class="exclusive shopBtn">
		</div>
	</div>
	</form>
</div>

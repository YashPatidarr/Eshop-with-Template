...
ResultSet rs=st.executeQuery(qr);
			if(rs.next())
			{
				...
				String num=rs.getString("ct_no");
				%>
			<pre>
<h3><%=name %></h3><h4><br>
Email - <h3><%=email %></h3></h4><br>
<h4>Gender- <h3><%=gender %></h3></h4><br>
<h4>City- <h3><%=city %></h3></h4><br>
<h4>Num- <h3><%=num %></h3></h4>
<h4><a class="shopBtn" href="EditPro.jsp?name=<%=name%>&gender=<%=gender%>&city=<%=city%>&num=<%=num%>&email=<%=email%>&pwd=<%=pwd%>" title="Edit Profile"> Edit Profile</a></h4>
</pre>	
				<% 
			}
			else

...
%>
			  ...
			  <div class="thumbnail">
				<img src="E:\Ecllipse Workspace1\Eshop with Template\WebContent\assets\img\products\<%=name%>.jpg" alt="<%=name%>">
				<div class="caption cntr">
					<h1><%=name %></h1>
			<h4>Rs.<%=price %></h4>
			<h4>Catagory-<%=cat %></h4>
			<h4>Company-<%=cmp%></h4>
			<h4>Mnft Year-<%=year %></h4>
			<h4>Product ID-<%=prid %></h4>						
...
<h4><a class="shopBtn" href="Buy.jsp?name=<%=name%>&price=<%=price%>&cat=<%=cat%>&cmp =<%=cmp%>&year=<%=year%>&prid=<%=prid%>&email=<%=email%>" title="Buy PRoduct"> Buy </a></h4>
					<br class="clr">
				</div>
			  </div>
